...
const chatbotToggler = document.querySelector("#chatbot-togler");
...
const API_KEY = "AIzaSyD1LdBQIbSzh31KBMZs7lVlz3fA2ORvJkM";
...
//generate bot response uing API
const generatebotResponse = async (incomingMessagediv) =>{
    ...
    try{
        ...
        messageElement.innerText = apirequestText ;
        ...
        //resets user file data,removing thinking indicator and scroll chat to bottom 
        userData.file = {};
...
//initailize emoji picker and handle emoji selection
